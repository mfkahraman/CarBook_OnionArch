...
{
    public class DefaultRecentBlogsComponentPartial(IHttpClientFactory httpClient) : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var lastThreeBlogs = values?.OrderByDescending(x => x.createdDate).Take(3).ToList();
