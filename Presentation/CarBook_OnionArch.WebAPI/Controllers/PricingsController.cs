...
namespace CarBook_OnionArch.WebAPI.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<List<GetPricingQueryResult>>> GetAll()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<GetPricingByIdQueryResult>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<GetPricingByIdQueryResult>> Create(CreatePricingCommand command)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Update(int id, UpdatePricingCommand command)
        {
            if (id != command.PricingId)
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await mediator.Send(new RemovePricingCommand(id));
