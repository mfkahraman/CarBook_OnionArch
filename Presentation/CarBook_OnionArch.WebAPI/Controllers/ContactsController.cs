...
namespace CarBook_OnionArch.WebAPI.Controllers
{
    ...
    [ApiController]
    public class ContactsController(CreateContactCommandHandler createHandler,
                                  UpdateContactCommandHandler updateHandler,
                                  RemoveContactCommandHandler removeHandler,
                                  GetContactByIdQueryHandler getByIdHandler,
                                  GetContactQueryHandler getAllQueryHandler) : ControllerBase
    {
        [HttpGet("get-all")]
        ...
        {
            var value = await getByIdHandler.Handle(new GetContactByIdQuery(id));
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                var result = await removeHandler.Handle(new RemoveContactCommand(id));
