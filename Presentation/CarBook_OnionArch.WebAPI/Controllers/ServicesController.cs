...
namespace CarBook_OnionArch.WebAPI.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<List<GetServiceQueryResult>>> GetAll()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<GetServiceByIdQueryResult>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<GetServiceByIdQueryResult>> Create(CreateServiceCommand command)
        {
            try
            {
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await mediator.Send(new RemoveServiceCommand(id));
