...
namespace CarBook_OnionArch.WebAPI.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<List<GetSocialMediaQueryResult>>> GetAll()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<GetSocialMediaByIdQueryResult>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<GetSocialMediaByIdQueryResult>> Create(CreateSocialMediaCommand command)
        {
            try
            {
                ...
                return CreatedAtAction(nameof(GetById), new { id = result.SocialMediaId }, result);
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Update(int id, UpdateSocialMediaCommand command)
        {
            if (id != command.SocialMediaId)
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await mediator.Send(new RemoveSocialMediaCommand(id));
