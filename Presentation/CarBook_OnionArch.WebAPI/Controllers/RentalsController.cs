...
namespace CarBook_OnionArch.WebAPI.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<List<GetRentalQueryResult>>> GetAll()
        {
            var values = await mediator.Send(new GetRentalQuery());
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<GetRentalByIdQueryResult>> GetById(int id)
        {
            var value = await mediator.Send(new GetRentalByIdQuery(id));
        ...
        [HttpPost]
        public async Task<ActionResult<GetRentalByIdQueryResult>> Create(CreateRentalCommand command)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Update(int id, UpdateRentalCommand command)
        {
            if (id != command.Id)
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await mediator.Send(new RemoveRentalCommand(id));
