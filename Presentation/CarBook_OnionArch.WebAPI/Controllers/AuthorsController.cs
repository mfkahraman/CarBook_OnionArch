...
namespace CarBook_OnionArch.WebAPI.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<List<GetAuthorsQueryResult>>> GetAll()
        {
            var values = await mediator.Send(new GetAuthorsQuery());
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<GetAuthorByIdQueryResult>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<GetAuthorByIdQueryResult>> Create(CreateAuthorCommand command)
        {
            try
            {
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await mediator.Send(new RemoveAuthorCommand(id));
